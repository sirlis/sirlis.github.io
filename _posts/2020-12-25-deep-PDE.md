...
作者致力于开发出一个灵活的框架，可以处理各类流动场，比如运载器附近的流动场，或者大脑或主动脉瘤中的血管流动场。

## 1.1. 网络框架

作者设计了一个网络框架，包含两个网络，但是他们共享参数。
...
$$
MSE = \frac{1}{N}\sum_{n=1}^N\vert c(t^n,x^n,y^n,z^n)-c^n \vert^2
$$
...
用来乘法方程的坐标的个数和位置是由人们完全掌控的，但是被动标量的密度只在测量点有数据。
