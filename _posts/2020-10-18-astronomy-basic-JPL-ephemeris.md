...
![image-20201018220334509](E:\GitHub\sirlis.github.io\assets\img\postsimg\20201018\1.jpg)
...
系数文件**ascp2000.405**则由若干个数据块组成，每个数据块为32天的数据。DE405的数据信息包括起始时间、结束时间、数据块的个数、每个数据块的数据个数、数据块的时间长度；天文常数包括光速、天文单位、地月质量比等；数据索引用来指示某一天体的数据在数据块内的位置。系数文件ascp2000.405由229个数据块组成，每个数据块代表32天，包含1018个数据。
