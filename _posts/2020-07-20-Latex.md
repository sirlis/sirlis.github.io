...
其中，`\label{fig:xxx}` 一定紧跟着要放在 `\caption{xxx}` 后面，在正文 `\ref{fig:xxx}` 时候才能正确编号。
...
更多参考：https://www.jianshu.com/p/22117d964baf或者自行百度。
...
以\begin{equation}…\end{equation}插入行间公式。如果不需要编号，公式开始字段后加上\nonumber。
...
![image-20200728112019180](E:\GitHub\sirlis.github.io\assets\img\postsimg\20200720\17.jpg)

### 参考文献的添加

复制给出的bib格式参考文献数据，添加到自己的.bib文件中。一些情况下还需要对信息进行增改，比如：
...
![image-20200728112121084](E:\GitHub\sirlis.github.io\assets\img\postsimg\20200720\18.jpg)

![image-20200728112137539](E:\GitHub\sirlis.github.io\assets\img\postsimg\20200720\19.jpg)

![image-20200728112147293](E:\GitHub\sirlis.github.io\assets\img\postsimg\20200720\20.jpg)
...
![image-20200728112456728](E:\GitHub\sirlis.github.io\assets\img\postsimg\20200720\21.jpg)

- 当前窗口激活为任意 .tex 文件，编译 .bib 文件（texStudio快捷键F8），生成.bbl文件，确保没有任何Warning

![image-20200728112517221](E:\GitHub\sirlis.github.io\assets\img\postsimg\20200720\22.jpg)
...
![image-20200728112543797](E:\GitHub\sirlis.github.io\assets\img\postsimg\20200720\23.jpg)
