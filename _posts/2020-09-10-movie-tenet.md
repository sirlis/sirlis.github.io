...
两个选择的区别在于，第一种选择需要**借助一张记有彩票号码的纸**来传递消息，这虽然增加了逻辑闭环的复杂度，但是当时间跨度非常长的时候，仅靠人力本身已经难以实现百万富翁的梦想了（比如你想让四十年前的自己中彩票，就必须逆向生活四十年，再返回到正向生活四十年，这基本是不可能的），就不得不借助能够在大尺度时间上记录和保存的媒介。
